...
Los departamentos con mayor población (ej. Bogotá, Antioquia, Valle) concentran la mayoría de los casos, pero en la fase exploratoria también se evidencian picos locales en municipios más pequeños, probablemente asociados a brotes localizados.

# ------------------------- Evaluación 4 -------------------------------------

## Descripción General
Este proyecto explora dos aplicaciones complementarias del *Machine Learning*:
1. **Análisis de Sentimientos (Amazon Reviews)**  
   Se entrena un modelo capaz de clasificar reseñas de productos de Amazon como **positivas (1)** o **negativas (0)**, utilizando procesamiento del lenguaje natural (NLP).  
   El objetivo es automatizar la interpretación de la opinión de los clientes y obtener métricas útiles sobre su satisfacción.

2. **Segmentación de Clientes (Mall Customers)**  
   Se agrupan clientes de un centro comercial en diferentes segmentos de mercado basándose en características demográficas y de consumo.  
   Esto permite diseñar estrategias de marketing personalizadas para cada grupo.

# Notebooks
## 1. `AmazonReviewsDataset.ipynb`
**Objetivo:** Clasificar reseñas de productos en positivas o negativas.  
**Metodología:**
- Carga y exploración del dataset.
- Preprocesamiento de texto: limpieza, tokenización y normalización.
- Vectorización con **TF-IDF**.
- Entrenamiento de modelos supervisados de clasificación.
- Visualización de resultados con **nubes de palabras (WordCloud)** y métricas de desempeño.
**Resultado esperado:**  
Un modelo de análisis de sentimientos capaz de identificar la polaridad de nuevas reseñas, aplicable a la monitorización de opiniones de clientes en tiempo real.

## 2. `MallCustomersDataSet.ipynb`
**Objetivo:** Identificar segmentos de clientes basados en edad, género e ingresos.  
**Metodología:**
- Análisis exploratorio de datos (EDA) para entender las variables.
- Escalado y preparación del dataset.
- Aplicación de tres métodos de clustering:
  - **K-Means**
  - **DBSCAN**
  - **Jerárquico**
